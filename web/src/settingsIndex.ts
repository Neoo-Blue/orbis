...
export const SETTINGS_INDEX: SettingsEntry[] = [
  ...
  { section: 'assistant', label: 'TypeSafe (domain judge, unblock, triage, device names)', keywords: 'typesafe jev ad tracker classifier smart capture api key probability unblock allow broken anomaly triage identify device type' },
